...
Reference repository for the [**API Design with Node.js, v5**](https://frontendmasters.com/courses/api-design-nodejs-v5/) Frontend Masters course. The goal is to document backend API design patterns and implementation choices, not to ship a production app.
